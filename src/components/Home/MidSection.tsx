...
const MidSection = () => {
  return (
    <>
      <div className="text-center flex justify-center pt-4 sm:pt-4 md:pt-20 mt-20">
        <div>
          <div className="mb-4">
            <Button
      ...
      `,
          ...
          >
            {/* Left Box */}
            <div
              className="relative bg-white rounded-lg shadow-lg overflow-hidden h-[300px]"
              style={{ gridArea: "left" }}
            >
              <Image
                src="/images/R1.png"
              ...
              <div className="absolute bottom-4 left-2">
                <div className="bg-[#AFAFAF] text-green-900 px-2 py-1 text-xs font-semibold rounded-xl w-fit">
                  <button>Upto 50% Off</button>
                </div>
                <h3 className="text-white text-sm font-extrabold mt-1 leading-tight">Get Exclusive Discount</h3>
                <p className="text-white text-xs">Discounts Up to 50% on exotic foods</p>
              </div>
            </div>

            {/* Middle Top Box */}
            <div
              className="relative bg-grey rounded-lg shadow-lg overflow-hidden h-[140px]"
            ...
            >
              ...
              <div className="absolute bottom-2 left-2">
                <div className="text-black text-xs font-poppins">SUMMER SALE</div>
                <h3 className="text-black text-sm font-bold font-poppins leading-tight">75% OFF</h3>
                <p className="text-black font-poppins text-xs">Only Fruits & Vegetable</p>
                <div className="text-[#00B207] text-xs font-poppins font-semibold">
            ...
            {/* Middle Bottom Box */}
            <div
              className="relative bg-white rounded-lg shadow-lg overflow-hidden h-[140px]"
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-2">
                <div className="text-white text-xs font-poppins">Best Deal</div>
                <h3 className="text-white text-sm font-bold font-poppins leading-tight">Special Product</h3>
                <h3 className="text-white text-sm font-bold font-poppins leading-tight">Deal of the Month</h3>
                <div className="text-[#00B207] text-xs font-poppins font-semibold mt-1">
                  <button>Shop Now →</button>
                </div>
              </div>
            </div>
            ...
            >
              ...
              />
              <div className="absolute bottom-4 left-2">
                <div className="bg-green-200 text-green-900 px-2 py-1 text-xs font-semibold rounded-xl w-fit">
                  <button>Shop Now!</button>
                </div>
                <h3 className="text-white text-sm font-extrabold mt-1 leading-tight">Summer</h3>
                <h3 className="text-white text-sm font-extrabold leading-tight">Sale</h3>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="hidden lg:block w-[80%] h-[40%]">
          ...
          >
            ...
            <div className="relative bg-grey rounded-lg shadow-lg overflow-hidden" style={{ gridArea: "middle-top" }}>
              <Image src="/images/U1.png" alt="Special Products" width={500} height={250} className="object-cover" />
              <div className="absolute bottom-28 left-4">
                <div className="text-black text-sm font-poppins">SUMMER SALE</div>
            ...
            <div
              ...
              style={{ gridArea: "middle-bottom" }}
            >
              <Image src="/images/D1.png" alt="Summer Sale" width={500} height={250} className="object-cover" />
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                <div className="text-white text-sm font-poppins">Best Deal</div>
